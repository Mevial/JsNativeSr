...
//     console.log(4);
// }
// Promise.resolve(console.log(5)).then(res => setTimeout(() => console.log('Promise ', res), 200));
...
// 10 12 14 0 1 2  // 0 1 2 // 12 14  // 10 0 12 1 14 2
...
export const createPromise = () => {
    ...
    handlePromise.promise
        .then(handlePromise.onSuccess) // .then(res => handlePromise.onSuccess(res))
